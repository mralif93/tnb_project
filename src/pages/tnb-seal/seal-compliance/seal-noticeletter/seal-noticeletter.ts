...
@IonicPage()
@Component({
  selector: 'page-seal-noticeletter',
  templateUrl: 'seal-noticeletter.html',
})

export class SealNoticeletterPage {
  ...
  public userDetailSelect: boolean = false;
  public descriptionToUser: boolean = false;
  public formA: boolean = false;
  public claim: boolean = false;
  public staffId: boolean = false;
  public custId: boolean = false;
  ...
  constructor(
    ...
    this.checklistMeter.ta4currentDate = moment().format('DD/MM/YYYY');
    ...
    for (var a = 0; a < this.itemOri.json.ta0feeder.length; a++) {
      this.itemOri.json.ta0feeder[a].multiassetlocci.filter((item) => {
        if (item.ta0allocationtype === DeviceConstants.DEV_ALLOC_MAIN_METER) {
          mainMeter.push(item);
        }
      });
    };
                    ...
                    [
                      [
                        ...
                        },
                        {
                          margin: [5, 10, 10, 5],
                          border: [true, true, true, true],
                          text: this.checklistMeter.ta4accountno,
                          fontSize: 8
                        }
                      ],
                      [
                        ...
                        },
                        {
                          margin: [5, 10, 10, 5],
                          border: [true, true, true, true],
                          text: this.checklistMeter.ta4currentDate,
                          fontSize: 8
                        }
                      ],
                    ]
                  ...
                  body:
                    [
                      ...
                      [
                        {
                          margin: [5, 5, 5, 5],
                          text: this.checklistMeter.remark1,
                          alignment: 'justify',
                          fontSize: 8
                        }
                      ]
                  ...
                  body:
                    [
                      ...
                      [
                        {
                          colSpan: 2,
                          image: this.checklistMeter.ta4signcustomer,
                          width: 100,
                          alignment: 'center'
                        },
                        '',
                        {
                          colSpan: 2,
                          image: this.checklistMeter.ta4signstaff,
                          width: 100,
                          alignment: 'center'
                        },
                        ''
                      ...
                      [
                        ...
                        {
                          margin: [3, 3, 3, 3],
                          text: ': ' + this.checklistMeter.customername,
                          // decoration: 'underline',
                          alignment: 'justify',
                          fontSize: 8
                        },
                        ...
                        {
                          margin: [3, 3, 3, 3],
                          text: ': ' + this.checklistMeter.staffname,
                          // decoration: 'underline',
                          alignment: 'justify',
                          fontSize: 8
                        }
                      ...
                      [
                        ...
                        {
                          margin: [3, 3, 3, 3],
                          text: ': ' + this.checklistMeter.nricWitness,
                          // decoration: 'underline',
                          alignment: 'justify',
                          fontSize: 8
                        },
                        ...
                        {
                          margin: [3, 3, 3, 3],
                          text: ': ' + this.checklistMeter.nriceStaff,
                          // decoration: 'underline',
                          alignment: 'justify',
                          fontSize: 8
                        }
