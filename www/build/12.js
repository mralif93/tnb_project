...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_13__pojo_RegisterGroupDetails__ = __webpack_require__(975);
...
var AddDevicesPage = /** @class */ (function () {
    function AddDevicesPage(navCtrl, navParams, appCtrl, jsonStoreCrud, dataService, gf, gv, loadingCtrl, barcodeScanner, toast, alertCtrl) {
        ...
        //this.voltageCode = "03";
        var SoInstallationVoltage = this.item.json.ta0installationvoltage;
        ...
        else if (this.deviceVoltage > __WEBPACK_IMPORTED_MODULE_7__pojo_commonEnum_DeviceConstants__["a" /* DeviceConstants */].VOL_LEVEL_LPC_LV_400V) {
            this.showPT = true;
            this.showSearchBtn = true;
            this.showCt = true;
        }
        ...
        for (var i = 0; i < this.item.json.ta0feeder.length; i++) {
            if (typeof (this.item.json.ta0feeder[i].feederSetDesign) !== 'undefined' && this.item.json.ta0feeder[i].feederSetDesign.length !== 0) {
                ...
                switch (this.worktype) {
                    ...
                    case __WEBPACK_IMPORTED_MODULE_5__pojo_commonEnum_SoTypes__["a" /* SoTypes */].ZSRO:
                    case __WEBPACK_IMPORTED_MODULE_5__pojo_commonEnum_SoTypes__["a" /* SoTypes */].ZCER:
                    case __WEBPACK_IMPORTED_MODULE_5__pojo_commonEnum_SoTypes__["a" /* SoTypes */].ZINL:
            ...
            case __WEBPACK_IMPORTED_MODULE_5__pojo_commonEnum_SoTypes__["a" /* SoTypes */].ZISR: {
                ...
                if (this.worktype === __WEBPACK_IMPORTED_MODULE_5__pojo_commonEnum_SoTypes__["a" /* SoTypes */].ZISR) {
                    ...
                    for (var i = 0; i < multiassectlocciLenght; i++) {
                        if (this.itemOri.json.ta0feeder[this.indexVal].multiassetlocci[i].ta0bcrmuploadindicator === __WEBPACK_IMPORTED_MODULE_7__pojo_commonEnum_DeviceConstants__["a" /* DeviceConstants */].BCRM_EXISTING_INDICATOR_CHECK) {
                            this.checkMeterAvailable = true;
                            break;
                        }
                        else {
    ...
    AddDevicesPage.prototype.ionViewDidLoad = function () {
        ...
        if (this.item.json.worktype !== __WEBPACK_IMPORTED_MODULE_5__pojo_commonEnum_SoTypes__["a" /* SoTypes */].ZIST) {
            ...
            if (typeof (this.item.json.ta0feeder[this.indexVal]) !== "undefined") {
                meter_new = this.item.json.ta0feeder[this.indexVal].multiassetlocci.filter(function (item) {
    ...
    AddDevicesPage.prototype.removeDeviceResult = function (resultArray, cont, device, type, soType) {
        var _this = this;
    ...
    AddDevicesPage.prototype.checkControlOptions = function (soType, container, cont) {
        ...
        var container;
        if (soType === __WEBPACK_IMPORTED_MODULE_5__pojo_commonEnum_SoTypes__["a" /* SoTypes */].ZSRO || soType === __WEBPACK_IMPORTED_MODULE_5__pojo_commonEnum_SoTypes__["a" /* SoTypes */].ZCER || soType === __WEBPACK_IMPORTED_MODULE_5__pojo_commonEnum_SoTypes__["a" /* SoTypes */].ZINR || soType === __WEBPACK_IMPORTED_MODULE_5__pojo_commonEnum_SoTypes__["a" /* SoTypes */].ZINL) {
        ...
        if (soType === __WEBPACK_IMPORTED_MODULE_5__pojo_commonEnum_SoTypes__["a" /* SoTypes */].ZUDN || soType === __WEBPACK_IMPORTED_MODULE_5__pojo_commonEnum_SoTypes__["a" /* SoTypes */].ZRPC) {
    ...
    AddDevicesPage.prototype.createFeederDeviceSet = function () {
     ...
     */
    AddDevicesPage.prototype.createFeederDeviceSetCtPt = function () {
        var ta0InstallationInd = null;
        if (__WEBPACK_IMPORTED_MODULE_5__pojo_commonEnum_SoTypes__["a" /* SoTypes */].ZIST === this.item.json.worktype) {
            ta0InstallationInd = true;
        }
    ...
    AddDevicesPage.prototype.assignFeederSet = function (multiAsset) {
                ...
                for (var i = 0; i < multiAsset.multiassetlocci.length; i++) {
                    ...
                    switch (multiAsset.multiassetlocci[i].ta0allocationtype) {
                        ...
                        case __WEBPACK_IMPORTED_MODULE_7__pojo_commonEnum_DeviceConstants__["a" /* DeviceConstants */].DEV_ALLOC_MODEM: {
                            console.log('modem device allocation : ' + __WEBPACK_IMPORTED_MODULE_7__pojo_commonEnum_DeviceConstants__["a" /* DeviceConstants */].DEV_ALLOC_MODEM);
                            ...
                            if (__WEBPACK_IMPORTED_MODULE_7__pojo_commonEnum_DeviceConstants__["a" /* DeviceConstants */].BCRM_EXISTING_INDICATOR_MAIN_MD === multiAsset.multiassetlocci[i].ta0bcrmuploadindicator || __WEBPACK_IMPORTED_MODULE_7__pojo_commonEnum_DeviceConstants__["a" /* DeviceConstants */].BCRM_NEW_INDICATOR_MAIN_MD === multiAsset.multiassetlocci[i].ta0bcrmuploadindicator) {
                                ...
                                if (multiAsset.multiassetlocci[i].ta0bcrmuploadindicator === __WEBPACK_IMPORTED_MODULE_7__pojo_commonEnum_DeviceConstants__["a" /* DeviceConstants */].BCRM_NEW_INDICATOR_MAIN_MD) {
                                ...
                                if (multiAsset.multiassetlocci[i].ta0bcrmuploadindicator === __WEBPACK_IMPORTED_MODULE_7__pojo_commonEnum_DeviceConstants__["a" /* DeviceConstants */].BCRM_NEW_INDICATOR_CHECK_MD) {
                        ...
                        case __WEBPACK_IMPORTED_MODULE_7__pojo_commonEnum_DeviceConstants__["a" /* DeviceConstants */].DEV_ALLOC_SIM_CARD: {
                            if (__WEBPACK_IMPORTED_MODULE_7__pojo_commonEnum_DeviceConstants__["a" /* DeviceConstants */].BCRM_EXISTING_INDICATOR_MAIN_SIM === multiAsset.multiassetlocci[i].ta0bcrmuploadindicator || __WEBPACK_IMPORTED_MODULE_7__pojo_commonEnum_DeviceConstants__["a" /* DeviceConstants */].BCRM_NEW_INDICATOR_MAIN_SIM === multiAsset.multiassetlocci[i].ta0bcrmuploadindicator) {
                                ...
                                if (multiAsset.multiassetlocci[i].ta0bcrmuploadindicator === __WEBPACK_IMPORTED_MODULE_7__pojo_commonEnum_DeviceConstants__["a" /* DeviceConstants */].BCRM_NEW_INDICATOR_MAIN_SIM) {
                                ...
                                if (multiAsset.multiassetlocci[i].ta0bcrmuploadindicator === __WEBPACK_IMPORTED_MODULE_7__pojo_commonEnum_DeviceConstants__["a" /* DeviceConstants */].BCRM_NEW_INDICATOR_CHECK_SIM) {
    ...
    AddDevicesPage.prototype.assignFeederSetCtPt = function (multiAsset) {
        var mCount = 0;
        var mmCount = 0;
        var msCount = 0;
        var cmCount = 0;
        ...
        if (this.worktype === __WEBPACK_IMPORTED_MODULE_5__pojo_commonEnum_SoTypes__["a" /* SoTypes */].ZRPC || this.worktype === __WEBPACK_IMPORTED_MODULE_5__pojo_commonEnum_SoTypes__["a" /* SoTypes */].ZUDN) {
            ...
            if (this.item.json.ta0newvoltage > 3 || this.item.json.ta0installationvoltage > 3 || this.deviceVoltage > __WEBPACK_IMPORTED_MODULE_7__pojo_commonEnum_DeviceConstants__["a" /* DeviceConstants */].VOL_LEVEL_LPC_LV_400V) {
                this.showPT = true;
                if (typeof (this.ptDevice0Array[0]) === 'undefined') {
                    var ptDeviceDetail = new __WEBPACK_IMPORTED_MODULE_2__pojo_MultiAssetLocci__["a" /* MultiAssetLocci */]();
                    ptDeviceDetail.devicetype = 'pt';
    ...
    AddDevicesPage.prototype.checkFeederMainMeterControllingDevice = function (multiAsset) {
    ...
    AddDevicesPage.prototype.addCtPt = function (dType) {
     ...
     */
    AddDevicesPage.prototype.assignCheckWindingGroup = function (event, itemBinding) {
     ...
     * @param itemBinding
     */
    AddDevicesPage.prototype.assignCheckWindingGroupWithTrans = function (event, transType, itemBinding) {
        if (event != 'undefined' && event != '') {
            itemBinding.ta0registers = [];
            var register = new __WEBPACK_IMPORTED_MODULE_13__pojo_RegisterGroupDetails__["a" /* RegisterGroupDetails */]();
    ...
    AddDevicesPage.prototype.checkAssetsAvailability = function (deviceDetailsArray, index, deviceType, deviceCategory) {
        var _this = this;
                        ...
                        if (_this.assetItem.length > 0) {
                            ...
                            */
                            ...
                            if (msgContent !== null && msgContent !== "") {
                                ...
                                if (deviceType === "meter" && deviceCategory === "main") {
                                    if (_this.assetItem != null && _this.assetItem != undefined && _this.assetItem != '') {
                                        _this.deviceVoltage = _this.assetItem[0].json.ta0devicevoltage;
                                        // Change View
                                        if (_this.deviceVoltage === __WEBPACK_IMPORTED_MODULE_7__pojo_commonEnum_DeviceConstants__["a" /* DeviceConstants */].VOL_LEVEL_LPC_LV_400V) {
                                            _this.showPT = false;
                                            _this.showSearchBtn = false;
                                            _this.showCt = true;
                                        }
                                        else if (_this.deviceVoltage > __WEBPACK_IMPORTED_MODULE_7__pojo_commonEnum_DeviceConstants__["a" /* DeviceConstants */].VOL_LEVEL_LPC_LV_400V) {
                                            _this.showPT = true;
                                        ...
                                        // Change Properties
                                        _this.createFeederDeviceSetCtPt();
                                    }
                                }
                            }
                        }
    ...
    AddDevicesPage.prototype.assignAssetDetailsToMultiasset = function (deviceDetails, assetItem) {
    ...
    AddDevicesPage.prototype.assignwindingTransformerType = function () {
     ...
     */
    AddDevicesPage.prototype.validateInstallation = function () {
     ...
     */
    AddDevicesPage.prototype.validationDeviceMandatory = function () {
        var type = this.item.json.worktype;
        var meterFlag = false;
        var mModem = false;
        var mSimcard = false;
    ...
    AddDevicesPage.prototype.saveDeviceDetails = function () {
        var _this = this;
            ...
            switch (this.itemOri.json.worktype) {
                ...
                case __WEBPACK_IMPORTED_MODULE_5__pojo_commonEnum_SoTypes__["a" /* SoTypes */].ZISR: {
                    ...
                    if (typeof (this.mainDeviceArray[0].assetnum) !== 'undefined' && this.mainDeviceArray[0].assetnum !== null && this.mainDeviceArray[0].assetnum !== '') {
                        ...
                        if ((this.worktype === __WEBPACK_IMPORTED_MODULE_5__pojo_commonEnum_SoTypes__["a" /* SoTypes */].ZISR || this.worktype === __WEBPACK_IMPORTED_MODULE_5__pojo_commonEnum_SoTypes__["a" /* SoTypes */].ZIST) && this.mainDeviceArray[0].ta0bcrmuploadindicator === __WEBPACK_IMPORTED_MODULE_7__pojo_commonEnum_DeviceConstants__["a" /* DeviceConstants */].BCRM_EXISTING_INDICATOR_MAIN) {
                    ...
                    if (typeof (this.mainModemArray[0].assetnum) !== 'undefined' && this.mainModemArray[0].assetnum !== null && this.mainModemArray[0].assetnum !== '') {
                        ...
                        if ((this.worktype === __WEBPACK_IMPORTED_MODULE_5__pojo_commonEnum_SoTypes__["a" /* SoTypes */].ZISR || this.worktype === __WEBPACK_IMPORTED_MODULE_5__pojo_commonEnum_SoTypes__["a" /* SoTypes */].ZIST) && this.mainModemArray[0].ta0bcrmuploadindicator === __WEBPACK_IMPORTED_MODULE_7__pojo_commonEnum_DeviceConstants__["a" /* DeviceConstants */].BCRM_EXISTING_INDICATOR_MAIN_MD) {
                    ...
                    if (typeof (this.mainSimcardArray[0].assetnum) !== 'undefined' && this.mainSimcardArray[0].assetnum !== null && this.mainSimcardArray[0].assetnum !== '') {
                        ...
                        if ((this.worktype === __WEBPACK_IMPORTED_MODULE_5__pojo_commonEnum_SoTypes__["a" /* SoTypes */].ZISR || this.worktype === __WEBPACK_IMPORTED_MODULE_5__pojo_commonEnum_SoTypes__["a" /* SoTypes */].ZIST) && this.mainSimcardArray[0].ta0bcrmuploadindicator === __WEBPACK_IMPORTED_MODULE_7__pojo_commonEnum_DeviceConstants__["a" /* DeviceConstants */].BCRM_EXISTING_INDICATOR_MAIN_SIM) {
                    ...
                    if (typeof (this.checkDeviceArray[0].assetnum) !== 'undefined' && this.checkDeviceArray[0].assetnum !== null && this.checkDeviceArray[0].assetnum !== '') {
                        ...
                        if ((this.worktype === __WEBPACK_IMPORTED_MODULE_5__pojo_commonEnum_SoTypes__["a" /* SoTypes */].ZISR || this.worktype === __WEBPACK_IMPORTED_MODULE_5__pojo_commonEnum_SoTypes__["a" /* SoTypes */].ZIST) && this.checkDeviceArray[0].ta0bcrmuploadindicator === __WEBPACK_IMPORTED_MODULE_7__pojo_commonEnum_DeviceConstants__["a" /* DeviceConstants */].BCRM_EXISTING_INDICATOR_CHECK) {
                    ...
                    if (typeof (this.checkModemArray[0].assetnum) !== 'undefined' && this.checkModemArray[0].assetnum !== null && this.checkModemArray[0].assetnum !== '') {
                        ...
                        if ((this.worktype === __WEBPACK_IMPORTED_MODULE_5__pojo_commonEnum_SoTypes__["a" /* SoTypes */].ZISR || this.worktype === __WEBPACK_IMPORTED_MODULE_5__pojo_commonEnum_SoTypes__["a" /* SoTypes */].ZIST) && this.checkModemArray[0].ta0bcrmuploadindicator === __WEBPACK_IMPORTED_MODULE_7__pojo_commonEnum_DeviceConstants__["a" /* DeviceConstants */].BCRM_EXISTING_INDICATOR_CHECK_MD) {
                    ...
                    if (typeof (this.checkSimcardArray[0].assetnum) !== 'undefined' && this.checkSimcardArray[0].assetnum !== null && this.checkSimcardArray[0].assetnum !== '') {
                        ...
                        if ((this.worktype === __WEBPACK_IMPORTED_MODULE_5__pojo_commonEnum_SoTypes__["a" /* SoTypes */].ZISR || this.worktype === __WEBPACK_IMPORTED_MODULE_5__pojo_commonEnum_SoTypes__["a" /* SoTypes */].ZIST) && this.checkSimcardArray[0].ta0bcrmuploadindicator === __WEBPACK_IMPORTED_MODULE_7__pojo_commonEnum_DeviceConstants__["a" /* DeviceConstants */].BCRM_EXISTING_INDICATOR_CHECK_SIM) {
                    ...
                    if ((typeof (this.ctDevice0Array[0].assetnum) !== 'undefined' || typeof (this.ctDevice0Array[0].ta0serialnum) !== 'undefined') &&
                        ...
                        if ((this.worktype === __WEBPACK_IMPORTED_MODULE_5__pojo_commonEnum_SoTypes__["a" /* SoTypes */].ZISR || this.worktype === __WEBPACK_IMPORTED_MODULE_5__pojo_commonEnum_SoTypes__["a" /* SoTypes */].ZIST) && this.ctDevice0Array[0].ta0bcrmuploadindicator === __WEBPACK_IMPORTED_MODULE_7__pojo_commonEnum_DeviceConstants__["a" /* DeviceConstants */].BCRM_EXISTING_INDICATOR_MAIN_CT) {
                    ...
                    if ((typeof (this.ctDevice1Array[0].assetnum) !== 'undefined' || typeof (this.ctDevice1Array[0].ta0serialnum) !== 'undefined') &&
                        ...
                        if ((this.worktype === __WEBPACK_IMPORTED_MODULE_5__pojo_commonEnum_SoTypes__["a" /* SoTypes */].ZISR || this.worktype === __WEBPACK_IMPORTED_MODULE_5__pojo_commonEnum_SoTypes__["a" /* SoTypes */].ZIST) && this.ctDevice1Array[0].ta0bcrmuploadindicator === __WEBPACK_IMPORTED_MODULE_7__pojo_commonEnum_DeviceConstants__["a" /* DeviceConstants */].BCRM_EXISTING_INDICATOR_MAIN_CT) {
                    ...
                    if ((typeof (this.ctDevice2Array[0].assetnum) !== 'undefined' || typeof (this.ctDevice2Array[0].ta0serialnum) !== 'undefined') &&
                        ...
                        if ((this.worktype === __WEBPACK_IMPORTED_MODULE_5__pojo_commonEnum_SoTypes__["a" /* SoTypes */].ZISR || this.worktype === __WEBPACK_IMPORTED_MODULE_5__pojo_commonEnum_SoTypes__["a" /* SoTypes */].ZIST) && this.ctDevice2Array[0].ta0bcrmuploadindicator === __WEBPACK_IMPORTED_MODULE_7__pojo_commonEnum_DeviceConstants__["a" /* DeviceConstants */].BCRM_EXISTING_INDICATOR_MAIN_CT) {
                    ...
                    if (this.deviceVoltage > __WEBPACK_IMPORTED_MODULE_7__pojo_commonEnum_DeviceConstants__["a" /* DeviceConstants */].VOL_LEVEL_LPC_LV_400V) {
                        if ((typeof (this.ptDevice0Array[0].assetnum) !== 'undefined' || typeof (this.ptDevice0Array[0].ta0serialnum) !== 'undefined') &&
                            ...
                            if (this.worktype === __WEBPACK_IMPORTED_MODULE_5__pojo_commonEnum_SoTypes__["a" /* SoTypes */].ZISR || (this.worktype === __WEBPACK_IMPORTED_MODULE_5__pojo_commonEnum_SoTypes__["a" /* SoTypes */].ZIST && this.ptDevice0Array[0].ta0bcrmuploadindicator === __WEBPACK_IMPORTED_MODULE_7__pojo_commonEnum_DeviceConstants__["a" /* DeviceConstants */].BCRM_EXISTING_INDICATOR_MAIN_PT)) {
                        ...
                        if ((typeof (this.ptDevice1Array[0].assetnum) !== 'undefined' || typeof (this.ptDevice1Array[0].ta0serialnum) !== 'undefined') &&
                            ...
                            if (this.worktype === __WEBPACK_IMPORTED_MODULE_5__pojo_commonEnum_SoTypes__["a" /* SoTypes */].ZISR || (this.worktype === __WEBPACK_IMPORTED_MODULE_5__pojo_commonEnum_SoTypes__["a" /* SoTypes */].ZIST && this.ptDevice1Array[0].ta0bcrmuploadindicator === __WEBPACK_IMPORTED_MODULE_7__pojo_commonEnum_DeviceConstants__["a" /* DeviceConstants */].BCRM_EXISTING_INDICATOR_MAIN_PT)) {
                        ...
                        if ((typeof (this.ptDevice2Array[0].assetnum) !== 'undefined' || typeof (this.ptDevice2Array[0].ta0serialnum) !== 'undefined') &&
                            ...
                            if (this.worktype === __WEBPACK_IMPORTED_MODULE_5__pojo_commonEnum_SoTypes__["a" /* SoTypes */].ZISR || (this.worktype === __WEBPACK_IMPORTED_MODULE_5__pojo_commonEnum_SoTypes__["a" /* SoTypes */].ZIST && this.ptDevice2Array[0].ta0bcrmuploadindicator === __WEBPACK_IMPORTED_MODULE_7__pojo_commonEnum_DeviceConstants__["a" /* DeviceConstants */].BCRM_EXISTING_INDICATOR_MAIN_PT)) {
            ...
            if (this.gv.testMobile && (__WEBPACK_IMPORTED_MODULE_7__pojo_commonEnum_DeviceConstants__["a" /* DeviceConstants */].NETWORK_UNKNOWN === this.gf.checkNetwork() || __WEBPACK_IMPORTED_MODULE_7__pojo_commonEnum_DeviceConstants__["a" /* DeviceConstants */].NETWORK_NONE === this.gf.checkNetwork())) {
                ...
                cordova.plugins.MobileSignal.getSignalStrength(function (data) {
                    if (_this.gv.deviceSignal <= data) {
                        ...
                        var itemValSingle_1 = null;
                        delete objfeeder['feederSetDesign'];
                        itemValSingle_1 = Object.assign({}, objfeeder);
                        itemValSingle_1.multiassetlocci = [];
                        // assign feeder description for present feeder device.
                        for (var _i = 0, _a = objfeeder.multiassetlocci; _i < _a.length; _i++) {
                            ...
                            if (typeof (multi.assetnum) !== 'undefined') {
                                ...
                                itemValSingle_1.multiassetlocci.push(multi);
                            }
                        }
                        // assign feeder description and controlling device for other feeder device.
                            ...
                            if (i !== _this.indexVal) {
                                if (typeof (_this.itemOri.json.ta0feeder[i].feederSetDesign) !== "undefined") {
                                    if (typeof (_this.itemOri.json.ta0feeder[i].feederSetDesign[0].eMeter) !== 'undefined'
                                        ...
                                        itemValSingle_1.multiassetlocci.push(eMulti);
                                        itemValSingle_1.multiassetlocci.push(nMulti);
                                    }
                        ...
                        _this.dataService.deleteDeviceList(_this.listRemoveDevice, _this.itemOri.json.wonum, 'device').then(function (results) {
                            _this.dataService
                                .saveRecordWithNewType(itemValSingle_1, _this.itemOri.json.wonum, __WEBPACK_IMPORTED_MODULE_7__pojo_commonEnum_DeviceConstants__["a" /* DeviceConstants */].PAGE_ACTION_MULTIASSETLOCCI, feederCode, _this.itemOri.json.worktype)
                                .then(function (results) {
                                    ...
                                    if (typeof (resultDes) !== "undefined" || resultDes !== null || resultDes !== '') {
                                        if (resultDes.processStatus === "failure") {
                                            ...
                                            if (typeof (resultDes.respObject) === "undefined" || resultDes.respObject === null || resultDes.respObject === '') {
                                                ...
                                                var successDevice = [];
                                                var ctptNew = [];
                                                ctptNew = newDevice.filter(function (item) {
                                                    return (item.ta0bcrmuploadindicator === __WEBPACK_IMPORTED_MODULE_7__pojo_commonEnum_DeviceConstants__["a" /* DeviceConstants */].BCRM_NEW_INDICATOR_MAIN_CT || item.ta0bcrmuploadindicator === __WEBPACK_IMPORTED_MODULE_7__pojo_commonEnum_DeviceConstants__["a" /* DeviceConstants */].BCRM_NEW_INDICATOR_MAIN_PT);
                                                });
                                                if (ctptNew.length > 0) {
                                                ...
                                                console.log('>>>> multiassetlocci 1 : ' + JSON.stringify(_this.itemOri.json.ta0feeder[_this.indexVal].multiassetlocci));
                                                ...
                                                if (successDevice.length > 0) {
                                                    ...
                                                    _this.itemOri.json.ta0feeder[_this.indexVal].multiassetlocci = [];
                                                    _this.itemOri.json.ta0feeder[_this.indexVal].multiassetlocci = oldDevice;
                                                    console.log('>>>> multiassetlocci 2 : ' + JSON.stringify(_this.itemOri.json.ta0feeder[_this.indexVal].multiassetlocci));
                                                }
                                            }
                                        }
                                    }
                ...
                var objfeeder = Object.assign({}, itemVal);
                var itemValSingle_2 = null;
                delete objfeeder['feederSetDesign'];
                itemValSingle_2 = Object.assign({}, objfeeder);
                itemValSingle_2.multiassetlocci = [];
                // assign feeder description for present feeder device.
                for (var _b = 0, _c = objfeeder.multiassetlocci; _b < _c.length; _b++) {
                    ...
                    if (typeof (multi.assetnum) !== 'undefined') {
                        ...
                        multi.ta0feedercode = feederCode;
                        multi.ta0feederdescription = this.item.json.ta0feeder[this.indexVal].description;
                        itemValSingle_2.multiassetlocci.push(multi);
                    }
                }
                // assign feeder description and controlling device for other feeder device.
                for (var i = 0; i < this.itemOri.json.ta0feeder.length; i++) {
                    if (i !== this.indexVal) {
                        if (typeof (this.itemOri.json.ta0feeder[i].feederSetDesign) !== "undefined") {
                            if (typeof (this.itemOri.json.ta0feeder[i].feederSetDesign[0].eMeter) !== 'undefined'
                                ...
                                delete nMulti['ta0stickerdetail'];
                                delete nMulti['ta0testdetail'];
                                itemValSingle_2.multiassetlocci.push(eMulti);
                                itemValSingle_2.multiassetlocci.push(nMulti);
                            }
                            else if (typeof (this.itemOri.json.ta0feeder[i].feederSetDesign[0].eMeter) !== 'undefined'
                                && typeof (this.itemOri.json.ta0feeder[i].feederSetDesign[0].nMeter) === 'undefined') {
                                var eMeterIndex = this.itemOri.json.ta0feeder[i].feederSetDesign[0].eMeterIndex;
                ...
                this.dataService.deleteDeviceList(this.listRemoveDevice, this.itemOri.json.wonum, 'device')
                    .then(function (results) {
                    _this.dataService
                        .saveRecordWithNewType(itemValSingle_2, _this.itemOri.json.wonum, __WEBPACK_IMPORTED_MODULE_7__pojo_commonEnum_DeviceConstants__["a" /* DeviceConstants */].PAGE_ACTION_MULTIASSETLOCCI, feederCode, _this.itemOri.json.worktype)
                        .then(function (results) {
                        // Clear Device Status & Removal Status
                        _this.removeDeviceRemovalStatus();
    ...
    AddDevicesPage.prototype.mainMeterChangesScenario = function () {
        if (this.mainDeviceArray.length === 2) {
            for (var i = 0; i < this.item.json.ta0feeder.length; i++) {
                if (typeof (this.item.json.ta0feeder[i].multiassetlocci) !== "undefined") {
                    if (i !== this.indexVal) {
    ...
    AddDevicesPage.prototype.RemovalMainMeterReadingSave = function () {
    ...
    AddDevicesPage.prototype.RemovalMainMeterReading = function () {
     ...
     * Date   : 02-11-2018
     */
    AddDevicesPage.prototype.removeDeviceRemovalStatus = function () {
    ...
    AddDevicesPage.prototype.checkUpdateSingleScenario = function (ChangeValue, arrayContent) {
        var result = '';
    ...
    AddDevicesPage.prototype.checkUpdateMultiScenario = function (ChangeValue, arrayContent) {
        var result = '';
        var arrayValue = arrayContent.length;
        if ((arrayValue > 1) && (ChangeValue > 1)) {
            result = arrayContent[1].assetnum;
    ...
    //Ameer
    AddDevicesPage.prototype.inputForMandatoryField = function () {
    ...
    AddDevicesPage.prototype.validateCt = function (keyVal, IndexVal) {
        this.checkCt = true;
        this.phaseColorR = false;
        this.phaseColorY = false;
        this.phaseColorB = false;
    ...
    AddDevicesPage.prototype.validatePt = function (keyValue, indexVal) {
        //
        this.checkPt = true;
        this.PtColorR = false;
        this.PtColorY = false;
    ...
    AddDevicesPage.prototype.addNewDeviceField = function (deviceType, parentType, tCheck) {
        ...
        switch (this.worktype) {
            ...
            case __WEBPACK_IMPORTED_MODULE_5__pojo_commonEnum_SoTypes__["a" /* SoTypes */].ZSRO:
            case __WEBPACK_IMPORTED_MODULE_5__pojo_commonEnum_SoTypes__["a" /* SoTypes */].ZRPM:
            case __WEBPACK_IMPORTED_MODULE_5__pojo_commonEnum_SoTypes__["a" /* SoTypes */].ZCER:
            case __WEBPACK_IMPORTED_MODULE_5__pojo_commonEnum_SoTypes__["a" /* SoTypes */].ZINL:
            case __WEBPACK_IMPORTED_MODULE_5__pojo_commonEnum_SoTypes__["a" /* SoTypes */].ZINR: {
                console.log('case ZINR');
                ...
                switch (deviceType) {
                    case __WEBPACK_IMPORTED_MODULE_7__pojo_commonEnum_DeviceConstants__["a" /* DeviceConstants */].DEVICE_TYPE_NAME_MAIN: {
                        ...
                        if (this.mainDeviceArray[0].ta0replaceind === true) {
                            ...
                            if (this.worktype === __WEBPACK_IMPORTED_MODULE_5__pojo_commonEnum_SoTypes__["a" /* SoTypes */].ZINL) {
                                this.item.json.ta0subsoindicator = true;
                            }
                            console.log("Show Add New Device Field...");
                            var deviceDetails = new __WEBPACK_IMPORTED_MODULE_2__pojo_MultiAssetLocci__["a" /* MultiAssetLocci */]();
    ...
    AddDevicesPage.prototype.lookup = function () {
        var _this = this;
        ...
        if (this.deviceVoltage === __WEBPACK_IMPORTED_MODULE_7__pojo_commonEnum_DeviceConstants__["a" /* DeviceConstants */].VOL_LEVEL_LPC_LV_400V) {
            if (this.item.json.worktype === __WEBPACK_IMPORTED_MODULE_5__pojo_commonEnum_SoTypes__["a" /* SoTypes */].ZUDN && this.item.json.ta0newvoltage > 3) {
                queryPart = WL.JSONStore.QueryPart().equal("ta0transformertype", "1"); // CT_MVHV
            }
            else if (this.item.json.worktype === __WEBPACK_IMPORTED_MODULE_5__pojo_commonEnum_SoTypes__["a" /* SoTypes */].ZUDN && this.item.json.ta0newvoltage < 4) {
                queryPart = WL.JSONStore.QueryPart().equal("ta0transformertype", "0"); // CT_LV
            }
            else {
                queryPart = WL.JSONStore.QueryPart().equal("ta0transformertype", "0"); // CT_LV
            ...
            if (this.item.json.worktype === __WEBPACK_IMPORTED_MODULE_5__pojo_commonEnum_SoTypes__["a" /* SoTypes */].ZUDN && this.item.json.ta0newvoltage < 4) {
                queryPart = WL.JSONStore.QueryPart().equal("ta0transformertype", "0"); // CT_LV
            }
            else if (this.item.json.worktype === __WEBPACK_IMPORTED_MODULE_5__pojo_commonEnum_SoTypes__["a" /* SoTypes */].ZUDN && this.item.json.ta0newvoltage > 3) {
                queryPart = WL.JSONStore.QueryPart().equal("ta0transformertype", "1"); // CT_MVHV
            }
            else {
                queryPart = WL.JSONStore.QueryPart().equal("ta0transformertype", "1"); // CT_MVHV
        ...
        if (this.item.json.ta0installationvoltage > 3 || this.item.json.ta0newvoltage > 3 || this.deviceVoltage > __WEBPACK_IMPORTED_MODULE_7__pojo_commonEnum_DeviceConstants__["a" /* DeviceConstants */].VOL_LEVEL_LPC_LV_400V) {
    ...
    AddDevicesPage.prototype.openDataValidationPage = function (assetDetails, multiAssetIndex) {
     ...
     */
    AddDevicesPage.prototype.checkAssetNumberInputType = function (eventVal, key, attr) {
        if (key === 'PT1' || key === 'PT2' || key === 'PT3') {
            var NUMBER_REGEXPASSETNUM = /^[a-zA-Z0-9/ -]*$/;
            var event_1 = eventVal.target.value;
            var regEXP = new RegExp(NUMBER_REGEXPASSETNUM);
            var valueSlice;
            if (!regEXP.test(event_1)) {
                valueSlice = event_1.substr(0, event_1.length - 1);
            ...
            var NUMBER_REGEXPASSETNUM = /^[a-zA-Z0-9/-]*$/;
            var event_2 = eventVal.target.value;
            var regEXP = new RegExp(NUMBER_REGEXPASSETNUM);
            var valueSlice;
            if (!regEXP.test(event_2)) {
                valueSlice = event_2.substr(0, event_2.length - 1);
                eventVal.target.value = valueSlice;
                //newValSlice = eventVal.target.value;
            }
            else {
    ...
    AddDevicesPage.prototype.CRInputType = function (event, key, indexArr) {
    ...
    //Ameer
    // edited by Ameer 4/10/2018 - 4.40 p.m
    AddDevicesPage.prototype.checkUserInputType = function (eventObj, keyVal, indexArr) {
        switch (keyVal) {
            case 'VA1':
    ...
    // Edited by Ameer 4/10/2018 - 4.40 p.m
    AddDevicesPage.prototype.PTCurrentRatio = function (event, key, indexArr) {
        var NUMBER_REGEXP = /^(\d{0,5}|(\d{0,5}(\.\d{0,3})))?$/;
        var newValue = event.target.value;
        var regExp = new RegExp(NUMBER_REGEXP);
        var arrayBeforeDecimal = [];
    ...
    // edited by Ameer 4/10/2018 - 4.40 p.m
    AddDevicesPage.prototype.checkUserInputPT = function (eventObj, keyVal, indexArr) {
        // 
        switch (keyVal) {
            case 'VA':
                var NUMBER_REGEXP = /^[A-Za-z0-9 ]*$/;
    ...
    AddDevicesPage.prototype.goBack = function () {
        // let newRootNav = <NavController>this.appCtrl.getRootNavById("n4");
        // newRootNav.push("ServiceExecutionPage", this.itemOri);
        this.navCtrl.pop();
    };
    AddDevicesPage.prototype.barcodeScan = function (deviceDetailsArray, index, deviceType, deviceCategory, deviceControl) {
        var _this = this;
        this.options = {
        ...
        this.barcodeScanner.scan(this.options).then(function (barcodeData) {
            ...
            if (barcodeData.cancelled) {
                ...
                if (deviceType === "meter" || deviceType === "modem" || deviceType === "sim" ||
                    (((deviceType === 'ct') && _this.item.json.ta0installationvoltage <= _this.dCons.VOL_LEVEL_LPC_LV_400V) ||
                        ((deviceType === 'ct') && _this.item.json.worktype === _this.soTypes.ZUDN && _this.item.json.ta0newvoltage <= _this.dCons.VOL_LEVEL_LPC_LV_400V))) {
     ...
     */
    AddDevicesPage.prototype.searchDevice = function (deviceDetailsArray, index, siteidVal, allocationTypeVal, deviceType, deviceCategory) {
        var _this = this;
        var item = [];
    ...
    AddDevicesPage.prototype.checkTickCt = function () {
    };
    AddDevicesPage.prototype.assignCheckMeterAllocationType = function () {
        // Assiging Allocation Type for Check Meter
        if (typeof (this.mainDeviceArray[1]) !== 'undefined') {
            if (this.mainDeviceArray[1].ta0allocationtype === this.dCons.DEV_ALLOC_MAIN_METER) {
                if (typeof (this.checkDeviceArray[1]) !== "undefined") {
    ...
    AddDevicesPage.prototype.checkingAssetnumArrayList = function (assetnum, category, index, type, transformer) {
    ...
    AddDevicesPage.prototype.selectWindingGroup = function (value, type) {
        var wGroup = null;
     ...
     * @param type
     */
    AddDevicesPage.prototype.convertTa0classBcrmMapping = function (ta0windingclass) {
     ...
     */
    AddDevicesPage.prototype.autoPopulateValueCtPt = function (device, type) {
     ...
     */
    AddDevicesPage.prototype.convertStringToArray = function (stringValue, type) {
        var arrayConvert = [];
        var arrayNew = [];
        var ctArray = [];
        var CR = '';
    ...
    AddDevicesPage.prototype.searchControllingDevice = function (meterDetailsArray) {
        var _this = this;
     ...
     */
    AddDevicesPage.prototype.showMainSection = function (index) {
        index++;
     ...
     * Edited   : Ameer(16/11/2018)
     */
    AddDevicesPage.prototype.showCheckSection = function (index) {
        index++;
     ...
     * Edited   : Ameer (16/11/2018)
     */
    AddDevicesPage.prototype.showCtTransformerSection = function (index) {
        index++;
    ...
    * Date     : 12-11-2018
    */
    AddDevicesPage.prototype.showPtTransformerSection = function (index) {
        index++;
   ...
   */
    AddDevicesPage.prototype.selectAll = function () {
     ...
     */
    AddDevicesPage.prototype.checkLengthOfCharacter = function (array) {
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__angular_core__ = __webpack_require__(0);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_ionic_angular__ = __webpack_require__(11);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__add_devices__ = __webpack_require__(1066);
