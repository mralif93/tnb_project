...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__pojo_StickerInfo__ = __webpack_require__(957);
...
var SilStickerInfoPage = /** @class */ (function () {
    function SilStickerInfoPage(navCtrl, params, toastCtrl, gf, dataService, jsonStore, loadingCtrl, gv, barcodeScanner, alertCtrl, toast, appCtrl, ds) {
        ...
        this.newterminalcover1 = new __WEBPACK_IMPORTED_MODULE_3__pojo_SealInfo__["a" /* SealInfo */]();
        this.newterminalcover2 = new __WEBPACK_IMPORTED_MODULE_3__pojo_SealInfo__["a" /* SealInfo */]();
        this.newmetercover1 = new __WEBPACK_IMPORTED_MODULE_3__pojo_SealInfo__["a" /* SealInfo */]();
        this.newmetercover2 = new __WEBPACK_IMPORTED_MODULE_3__pojo_SealInfo__["a" /* SealInfo */]();
        this.newmetercover3 = new __WEBPACK_IMPORTED_MODULE_3__pojo_SealInfo__["a" /* SealInfo */]();
        this.newmdbutton = new __WEBPACK_IMPORTED_MODULE_3__pojo_SealInfo__["a" /* SealInfo */]();
        this.newopticaleyecover = new __WEBPACK_IMPORTED_MODULE_3__pojo_SealInfo__["a" /* SealInfo */]();
        this.newmeterbattery = new __WEBPACK_IMPORTED_MODULE_3__pojo_SealInfo__["a" /* SealInfo */]();
        this.newcommmodule = new __WEBPACK_IMPORTED_MODULE_3__pojo_SealInfo__["a" /* SealInfo */]();
       ...
       */
        ...
        if (typeof (this.item.json.ta0feeder[this.fIndex].multiassetlocci[this.maIndex].ta0sealdetail) != 'undefined' &&
            ...
            for (var i = 0; i < seal_length; i++) {
                ...
                if (ta0seallocation.startsWith(__WEBPACK_IMPORTED_MODULE_6__pojo_commonEnum_FunctionClass__["a" /* FunctionClass */].METER_COVER) && ta0sealdetail.ta0existingseal === true) {
                ...
                else if (ta0seallocation.startsWith(__WEBPACK_IMPORTED_MODULE_6__pojo_commonEnum_FunctionClass__["a" /* FunctionClass */].TERMINAL_COVER) && ta0sealdetail.ta0existingseal === true) {
                ...
                else if (ta0seallocation.startsWith(__WEBPACK_IMPORTED_MODULE_6__pojo_commonEnum_FunctionClass__["a" /* FunctionClass */].MD_BUTTON) && ta0sealdetail.ta0existingseal === true) {
                ...
                else if (ta0seallocation.startsWith(__WEBPACK_IMPORTED_MODULE_6__pojo_commonEnum_FunctionClass__["a" /* FunctionClass */].METER_BATTERY) && ta0sealdetail.ta0existingseal === true) {
                ...
                else if (ta0seallocation.startsWith(__WEBPACK_IMPORTED_MODULE_6__pojo_commonEnum_FunctionClass__["a" /* FunctionClass */].COMM_MODULE) && ta0sealdetail.ta0existingseal === true) {
                ...
                else if (ta0seallocation.startsWith(__WEBPACK_IMPORTED_MODULE_6__pojo_commonEnum_FunctionClass__["a" /* FunctionClass */].OPTICAL_EYE_COVER) && ta0sealdetail.ta0existingseal === true) {
                ...
                else if (ta0seallocation.startsWith(__WEBPACK_IMPORTED_MODULE_6__pojo_commonEnum_FunctionClass__["a" /* FunctionClass */].MD_BUTTON) && ta0sealdetail.ta0existingseal === false) {
                    this.newmdbutton = ta0sealdetail;
                }
                else if (ta0seallocation.startsWith(__WEBPACK_IMPORTED_MODULE_6__pojo_commonEnum_FunctionClass__["a" /* FunctionClass */].METER_BATTERY) && ta0sealdetail.ta0existingseal === false) {
                    this.newopticaleyecover = ta0sealdetail;
                }
                else if (ta0seallocation.startsWith(__WEBPACK_IMPORTED_MODULE_6__pojo_commonEnum_FunctionClass__["a" /* FunctionClass */].OPTICAL_EYE_COVER) && ta0sealdetail.ta0existingseal === false) {
                    this.newterminalcover1 = ta0sealdetail;
                }
                else if (ta0seallocation.startsWith(__WEBPACK_IMPORTED_MODULE_6__pojo_commonEnum_FunctionClass__["a" /* FunctionClass */].COMM_MODULE) && ta0sealdetail.ta0existingseal === false) {
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__angular_core__ = __webpack_require__(0);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_ionic_angular__ = __webpack_require__(11);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__sil_sticker_info__ = __webpack_require__(1070);
var __decorate = (this && this.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
