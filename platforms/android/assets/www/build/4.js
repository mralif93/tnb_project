...
"use strict";
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "a", function() { return SealPhotoAttachmentPage; });
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6__pojo_FeederDetails__ = __webpack_require__(959);
 ...
 */
var SealPhotoAttachmentPage = /** @class */ (function () {
    function SealPhotoAttachmentPage(navCtrl, navParams, jsonStore, gv, gf) {
        this.navCtrl = navCtrl;
        this.navParams = navParams;
        this.jsonStore = jsonStore;
        this.gv = gv;
        this.gf = gf;
        this.pageTitle = 'Attachment';
        this.segmentSection = "Image";
        this.optionFeeder = [];
    }
    SealPhotoAttachmentPage.prototype.ionViewWillEnter = function () {
        var _this = this;
        debugger;
        var wonum = this.navParams.get("wonum");
        var queryPart = WL.JSONStore.QueryPart().equal("wonum", wonum);
        this.jsonStore.getSearchRecord(__WEBPACK_IMPORTED_MODULE_2__pojo_commonEnum_Domains__["a" /* Domains */].LPCWORKORDER, queryPart, 0).then(function (result) {
            console.info("result Message: ", result);
            _this.item = result[0];
            _this.findFeederDetails(_this.item);
            _this.attachment = _this.item.json.docLinksL;
            _this.attachment.forEach(function (imageHref) {
                imageHref.href + '?_lid=' + _this.gv.username + '&_lpwd=' + _this.gv.password;
            });
            console.table(_this.attachment);
        });
    };
    SealPhotoAttachmentPage.prototype.ionViewDidLoad = function () {
        console.log('ionViewDidLoad SealPhotoAttachmentPage');
    };
    SealPhotoAttachmentPage.prototype.goBack = function () {
        this.navCtrl.pop();
    };
    SealPhotoAttachmentPage.prototype.findFeederDetails = function (item) {
        var feeder;
        var feeder_id_code_exist = [];
        var feeder_id_code_new = [];
        // Checking total feeder for ZISP
        if (item.json.worktype === __WEBPACK_IMPORTED_MODULE_4__pojo_commonEnum_SoTypes__["a" /* SoTypes */].ZISP || (item.json.worktype === __WEBPACK_IMPORTED_MODULE_4__pojo_commonEnum_SoTypes__["a" /* SoTypes */].ZIST && item.json.ta0installationvoltage > __WEBPACK_IMPORTED_MODULE_5__pojo_commonEnum_DeviceConstants__["a" /* DeviceConstants */].VOL_LEVEL_LPC_LV_400V)) {
            ...
            if (typeof (item.json.ta0feeder) !== "undefined" && item.json.ta0feeder !== null && item.json.ta0feeder !== "") {
                ...
                for (var k = 0; k < item.json.ta0feeder.length; k++) {
                    ...
                    if (typeof (item.json.ta0feeder[k].multiassetlocci) !== "undefined" && item.json.ta0feeder[k].multiassetlocci !== null && item.json.ta0feeder[k].multiassetlocci !== "") {
                        ...
                        var mDevice = item.json.ta0feeder[k].multiassetlocci.find(function (itemVal) {
                            if (itemVal.ta0devicevoltage > __WEBPACK_IMPORTED_MODULE_5__pojo_commonEnum_DeviceConstants__["a" /* DeviceConstants */].VOL_LEVEL_LPC_LV_400V && itemVal.ta0bcrmuploadindicator === __WEBPACK_IMPORTED_MODULE_5__pojo_commonEnum_DeviceConstants__["a" /* DeviceConstants */].BCRM_EXISTING_INDICATOR_MAIN) {
                                fci_e = item.json.ta0feeder[k];
                            }
                            return itemVal.ta0devicevoltage > __WEBPACK_IMPORTED_MODULE_5__pojo_commonEnum_DeviceConstants__["a" /* DeviceConstants */].VOL_LEVEL_LPC_LV_400V && itemVal.ta0bcrmuploadindicator === __WEBPACK_IMPORTED_MODULE_5__pojo_commonEnum_DeviceConstants__["a" /* DeviceConstants */].BCRM_EXISTING_INDICATOR_MAIN;
                        });
                        ...
                        var nmDevice = item.json.ta0feeder[k].multiassetlocci.find(function (itemVal) {
                            if (itemVal.ta0devicevoltage > __WEBPACK_IMPORTED_MODULE_5__pojo_commonEnum_DeviceConstants__["a" /* DeviceConstants */].VOL_LEVEL_LPC_LV_400V && itemVal.ta0bcrmuploadindicator === __WEBPACK_IMPORTED_MODULE_5__pojo_commonEnum_DeviceConstants__["a" /* DeviceConstants */].BCRM_NEW_INDICATOR_MAIN) {
                                fci_n = item.json.ta0feeder[k];
                            }
                            return itemVal.ta0devicevoltage > __WEBPACK_IMPORTED_MODULE_5__pojo_commonEnum_DeviceConstants__["a" /* DeviceConstants */].VOL_LEVEL_LPC_LV_400V && itemVal.ta0bcrmuploadindicator === __WEBPACK_IMPORTED_MODULE_5__pojo_commonEnum_DeviceConstants__["a" /* DeviceConstants */].BCRM_NEW_INDICATOR_MAIN;
                        });
                ...
                if (item.json.worktype === __WEBPACK_IMPORTED_MODULE_4__pojo_commonEnum_SoTypes__["a" /* SoTypes */].ZISP) {
                    feeder = mainDevice;
                }
                else {
                    feeder = nMainDevice;
                ...
                for (var a = 0; a < feeder.length; a++) {
                    if (mainDevice.length > 0) {
                        var feederVal;
                        feederVal = new __WEBPACK_IMPORTED_MODULE_6__pojo_FeederDetails__["a" /* FeederDetails */]();
                        feederVal = {};
                    ...
                    if (nMainDevice.length > 0) {
                        if (item.json.worktype === __WEBPACK_IMPORTED_MODULE_4__pojo_commonEnum_SoTypes__["a" /* SoTypes */].ZIST) {
                            var feederVal;
                            feederVal = new __WEBPACK_IMPORTED_MODULE_6__pojo_FeederDetails__["a" /* FeederDetails */]();
                            feederVal = {};
    ...
    return SealPhotoAttachmentPage;
}());

//# sourceMappingURL=seal-photo-attachment.js.map
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__angular_core__ = __webpack_require__(0);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__testing_testing__ = __webpack_require__(1092);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__angular_common__ = __webpack_require__(39);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__attachment_attachment__ = __webpack_require__(1094);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__pdf_attachment_pdf_attachment__ = __webpack_require__(1095);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__phasor_diagram_phasor_diagram__ = __webpack_require__(1096);
var __decorate = (this && this.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
...
var PipesModule = /** @class */ (function () {
    ...
    PipesModule = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["NgModule"])({
            declarations: [__WEBPACK_IMPORTED_MODULE_1__testing_testing__["a" /* TestingPipe */],
                __WEBPACK_IMPORTED_MODULE_3__attachment_attachment__["a" /* AttachmentPipe */],
                __WEBPACK_IMPORTED_MODULE_3__attachment_attachment__["a" /* AttachmentPipe */],
                __WEBPACK_IMPORTED_MODULE_4__pdf_attachment_pdf_attachment__["a" /* PdfAttachmentPipe */],
                __WEBPACK_IMPORTED_MODULE_5__phasor_diagram_phasor_diagram__["a" /* PhasorDiagramPipe */]],
            imports: [__WEBPACK_IMPORTED_MODULE_2__angular_common__["CommonModule"]],
            exports: [__WEBPACK_IMPORTED_MODULE_1__testing_testing__["a" /* TestingPipe */],
                __WEBPACK_IMPORTED_MODULE_3__attachment_attachment__["a" /* AttachmentPipe */],
                __WEBPACK_IMPORTED_MODULE_3__attachment_attachment__["a" /* AttachmentPipe */],
                __WEBPACK_IMPORTED_MODULE_4__pdf_attachment_pdf_attachment__["a" /* PdfAttachmentPipe */],
                __WEBPACK_IMPORTED_MODULE_5__phasor_diagram_phasor_diagram__["a" /* PhasorDiagramPipe */]],
            providers: [__WEBPACK_IMPORTED_MODULE_1__testing_testing__["a" /* TestingPipe */]]
        })
    ], PipesModule);
    return PipesModule;
}());
...
"use strict";
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "a", function() { return TestingPipe; });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__angular_core__ = __webpack_require__(0);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_lodash__ = __webpack_require__(1093);
 ...
 */
var TestingPipe = /** @class */ (function () {
     ...
     */
    TestingPipe.prototype.transform = function (value, by, direction) {
        debugger;
        value = __WEBPACK_IMPORTED_MODULE_1_lodash__["orderBy"](value, [by], direction);
        return value;
    };
    TestingPipe = __decorate([
...
/* WEBPACK VAR INJECTION */}.call(exports, __webpack_require__(75), __webpack_require__(522)(module)))
...
"use strict";
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "a", function() { return AttachmentPipe; });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__angular_core__ = __webpack_require__(0);
var __decorate = (this && this.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
 ...
 * See https://angular.io/api/core/Pipe for more info on Angular Pipes.
 */
var AttachmentPipe = /** @class */ (function () {
    function AttachmentPipe() {
    }
    /**
     * Takes a value and makes it lowercase.
     */
    AttachmentPipe.prototype.transform = function (value) {
        if (typeof (value) !== 'undefined') {
            var filterItem = value.filter(function (item) { return item.describedBy.docType === "AI" || item.describedBy.docType === "RI" || item.describedBy.docType === "PI"; });
            return filterItem;
        }
    };
    AttachmentPipe = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["Pipe"])({
            name: 'photo',
        })
    ], AttachmentPipe);
    return AttachmentPipe;
}());
...
"use strict";
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "a", function() { return PdfAttachmentPipe; });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__angular_core__ = __webpack_require__(0);
var __decorate = (this && this.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
 ...
 * See https://angular.io/api/core/Pipe for more info on Angular Pipes.
 */
var PdfAttachmentPipe = /** @class */ (function () {
    function PdfAttachmentPipe() {
    }
    /**
     * Takes a value and makes it lowercase.
     */
    PdfAttachmentPipe.prototype.transform = function (value) {
        if (typeof (value) !== 'undefined') {
            var filterItem = value.filter(function (item) { return item.describedBy.docType === "CF"; });
            return filterItem;
        }
    };
    PdfAttachmentPipe = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["Pipe"])({
            name: 'pdfAttachment',
        })
    ], PdfAttachmentPipe);
    return PdfAttachmentPipe;
}());

//# sourceMappingURL=pdf-attachment.js.map
...
"use strict";
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "a", function() { return PhasorDiagramPipe; });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__angular_core__ = __webpack_require__(0);
var __decorate = (this && this.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
 ...
 * See https://angular.io/api/core/Pipe for more info on Angular Pipes.
 */
var PhasorDiagramPipe = /** @class */ (function () {
    function PhasorDiagramPipe() {
    }
    PhasorDiagramPipe.prototype.transform = function (value) {
        if (typeof (value) !== 'undefined') {
            var filterItem = value.filter(function (item) { return item.describedBy.docType === "PD" || item.describedBy.docType === "DD"; });
            return filterItem;
        }
    };
    PhasorDiagramPipe = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["Pipe"])({
            name: 'phasorDiagram',
        })
    ], PhasorDiagramPipe);
    return PhasorDiagramPipe;
}());

//# sourceMappingURL=phasor-diagram.js.map
...
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "SealPhotoAttachmentPageModule", function() { return SealPhotoAttachmentPageModule; });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__angular_core__ = __webpack_require__(0);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_ionic_angular__ = __webpack_require__(11);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__seal_photo_attachment__ = __webpack_require__(1090);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__components_components_module__ = __webpack_require__(509);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__pipes_pipes_module__ = __webpack_require__(1091);
var __decorate = (this && this.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
...
var SealPhotoAttachmentPageModule = /** @class */ (function () {
    function SealPhotoAttachmentPageModule() {
    }
    SealPhotoAttachmentPageModule = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["NgModule"])({
            declarations: [
                __WEBPACK_IMPORTED_MODULE_2__seal_photo_attachment__["a" /* SealPhotoAttachmentPage */],
            ],
            imports: [
                __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["IonicPageModule"].forChild(__WEBPACK_IMPORTED_MODULE_2__seal_photo_attachment__["a" /* SealPhotoAttachmentPage */]),
                __WEBPACK_IMPORTED_MODULE_3__components_components_module__["a" /* ComponentsModule */],
                __WEBPACK_IMPORTED_MODULE_4__pipes_pipes_module__["a" /* PipesModule */]
            ],
        })
    ], SealPhotoAttachmentPageModule);
    return SealPhotoAttachmentPageModule;
}());

//# sourceMappingURL=seal-photo-attachment.module.js.map
