...
var SealCrimplessSealPage = /** @class */ (function () {
    function SealCrimplessSealPage(navCtrl, loadingCtrl, navParams, gv, jsonStore, params, barcodeScanner, gf, toast, dataService, alertCtrl) {
        ...
        this.meterKiosk1NewArray = []; //Panel Door Kiosk 1
        this.meterKiosk2NewArray = []; //Panel Door Kiosk 2
        this.meterTestBoxNewArray1 = []; //Meter Test Box 1
        this.meterTestBoxNewArray2 = []; //Meter Test Box 2
        this.ctChamberNewArrayF1 = []; //CT Chamber
        this.ptChamberNewArrayF1 = []; //PT Chamber
        this.terminalBoxNewArrayF1 = []; //Terminal Box
        this.marshallingBoxNewArrayF1 = []; //Marshalling Box
        this.ptSecondaryFuseNewArrayF1 = []; //PT Secondary Fuse
    ...
    SealCrimplessSealPage.prototype.deletePtChamber = function (mIndex, from) {
        if (from == 'f1') {
            if (mIndex != 0) {
    ...
    SealCrimplessSealPage.prototype.deleteCtChamber = function (mIndex, from) {
        if (from == 'f1') {
            if (mIndex != 0) {
    ...
    SealCrimplessSealPage.prototype.addMeterTestBox = function (from) {
        if (from == '1') {
    ...
    SealCrimplessSealPage.prototype.deleteMeterTestBox = function (mIndex, from) {
        if (from == '1') {
            if (mIndex != 0) {
    ...
    SealCrimplessSealPage.prototype.addMeterKiosk = function (from) {
        if (from == '1') {
    ...
    SealCrimplessSealPage.prototype.deleteMeterKiosk = function (mIndex, from) {
        if (from == '1') {
            if (mIndex != 0) {
    ...
    SealCrimplessSealPage.prototype.addSfuseF1 = function () {
    ...
    SealCrimplessSealPage.prototype.deleteSfuse = function (mIndex, from) {
        if (from == 'f1') {
            if (mIndex != 0) {
    ...
    //Add Test Block
    SealCrimplessSealPage.prototype.addTtb = function (from) {
        if (from == 'f1') {
    ...
    SealCrimplessSealPage.prototype.deleteTtb = function (mIndex, from) {
        if (from == 'f1') {
            if (mIndex != 0) {
                this.ttbF1Array.pop();
    ...
    SealCrimplessSealPage.prototype.checkingFieldDisabledF1 = function (attr, category) {
        if (category === "seal") {
    ...
    SealCrimplessSealPage.prototype.checkingFieldDisabledF2 = function (attr, category) {
        if (category === "seal") {
            if (typeof (attr.ta0sealnum) !== "undefined" && attr.ta0removeind === false) {
                return false;
            }
    ...
    SealCrimplessSealPage.prototype.checkingFieldDisabledF3 = function (attr, category) {
        if (category === "seal") {
            if (typeof (attr.ta0sealnum) !== "undefined" && attr.ta0removeind === false) {
                return false;
            }
    ...
    SealCrimplessSealPage.prototype.addMeterCover = function () {
    ...
    SealCrimplessSealPage.prototype.deleteMeterCover = function (mIndex) {
        if (mIndex != 0) {
    ...
    SealCrimplessSealPage.prototype.userInputLengthNum = function (eventData, nameText, indexArray, type) {
        switch (nameText) {
            case 'mtrCover':
    ...
    SealCrimplessSealPage.prototype.loadFeederDesign = function (feederArr) {
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__angular_core__ = __webpack_require__(0);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_ionic_angular__ = __webpack_require__(11);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__seal_crimpless_seal__ = __webpack_require__(1067);
var __decorate = (this && this.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
