...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__pojo_SealInfo__ = __webpack_require__(948);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__pojo_StickerInfo__ = __webpack_require__(949);
       ...
       */
        ...
        if (typeof (this.item.json.ta0feeder[this.fIndex].multiassetlocci[this.maIndex].ta0sealdetail) != 'undefined' &&
            ...
            for (var i = 0; i < seal_length; i++) {
                ...
                else if (ta0seallocation.startsWith(__WEBPACK_IMPORTED_MODULE_5__pojo_commonEnum_FunctionClass__["a" /* FunctionClass */].TERMINAL_CT_RED)) {
                    ta0sealdetail.forEach(function (res) {
                ...
                else if (ta0seallocation.startsWith(__WEBPACK_IMPORTED_MODULE_5__pojo_commonEnum_FunctionClass__["a" /* FunctionClass */].TERMINAL_CT_YELLOW)) {
                    ta0sealdetail.forEach(function (res) {
                        res.ta0removeind = res.ta0removeind ? res.ta0removeind : false;
                    });
                ...
                else if (ta0seallocation.startsWith(__WEBPACK_IMPORTED_MODULE_5__pojo_commonEnum_FunctionClass__["a" /* FunctionClass */].TERMINAL_CT_BLUE)) {
                    ta0sealdetail.forEach(function (res) {
                        res.ta0removeind = res.ta0removeind ? res.ta0removeind : false;
                    });
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__angular_core__ = __webpack_require__(0);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_ionic_angular__ = __webpack_require__(11);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__seal_device_sil_sticker_info__ = __webpack_require__(1078);
var __decorate = (this && this.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
